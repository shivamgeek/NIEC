...
--
-- Table structure for table `RESULT_IT_`
--

DROP TABLE IF EXISTS `RESULT_IT_`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RESULT_IT_` (
...
--
-- Dumping data for table `RESULT_IT_`
--

LOCK TABLES `RESULT_IT_` WRITE;
/*!40000 ALTER TABLE `RESULT_IT_` DISABLE KEYS */;
/*!40000 ALTER TABLE `RESULT_IT_` ENABLE KEYS */;
UNLOCK TABLES;
