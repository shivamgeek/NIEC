...
--
-- Table structure for table `RESULT_ECE`
--

DROP TABLE IF EXISTS `RESULT_ECE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RESULT_ECE` (
...
--
-- Dumping data for table `RESULT_ECE`
--

LOCK TABLES `RESULT_ECE` WRITE;
/*!40000 ALTER TABLE `RESULT_ECE` DISABLE KEYS */;
/*!40000 ALTER TABLE `RESULT_ECE` ENABLE KEYS */;
UNLOCK TABLES;
