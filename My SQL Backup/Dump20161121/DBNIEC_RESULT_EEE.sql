...
--
-- Table structure for table `RESULT_EEE`
--

DROP TABLE IF EXISTS `RESULT_EEE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RESULT_EEE` (
...
--
-- Dumping data for table `RESULT_EEE`
--

LOCK TABLES `RESULT_EEE` WRITE;
/*!40000 ALTER TABLE `RESULT_EEE` DISABLE KEYS */;
/*!40000 ALTER TABLE `RESULT_EEE` ENABLE KEYS */;
UNLOCK TABLES;
