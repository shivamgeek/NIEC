...
--
-- Table structure for table `RESULT_MEC`
--

DROP TABLE IF EXISTS `RESULT_MEC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RESULT_MEC` (
...
--
-- Dumping data for table `RESULT_MEC`
--

LOCK TABLES `RESULT_MEC` WRITE;
/*!40000 ALTER TABLE `RESULT_MEC` DISABLE KEYS */;
/*!40000 ALTER TABLE `RESULT_MEC` ENABLE KEYS */;
UNLOCK TABLES;
