...
--
-- Table structure for table `STUDENT_CIV`
--

DROP TABLE IF EXISTS `STUDENT_CIV`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `STUDENT_CIV` (
...
--
-- Dumping data for table `STUDENT_CIV`
--

LOCK TABLES `STUDENT_CIV` WRITE;
/*!40000 ALTER TABLE `STUDENT_CIV` DISABLE KEYS */;
/*!40000 ALTER TABLE `STUDENT_CIV` ENABLE KEYS */;
UNLOCK TABLES;
