...
--
-- Table structure for table `RESULT_CIV`
--

DROP TABLE IF EXISTS `RESULT_CIV`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RESULT_CIV` (
...
--
-- Dumping data for table `RESULT_CIV`
--

LOCK TABLES `RESULT_CIV` WRITE;
/*!40000 ALTER TABLE `RESULT_CIV` DISABLE KEYS */;
/*!40000 ALTER TABLE `RESULT_CIV` ENABLE KEYS */;
UNLOCK TABLES;
